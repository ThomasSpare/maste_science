...
import "./DeliverablesPublic.css";
import "../App.css"; 

const DeliverabelsPublic = () => {
    ...
    const filteredUploads = uploads.filter((upload) => {
        ...
        return isWithinDateRange && matchesSearchTerm && isPublic && isDeliverable;
    });
    ...
    return (
        <div className='search-main-div'>
            <h1 className='search-h1'>Search Public Deliverables</h1>
            <div>
...
export default DeliverabelsPublic;